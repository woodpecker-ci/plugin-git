...
func main() {
	...
	app.Flags = []cli.Flag{
		&cli.StringFlag{
			...
			EnvVars: []string{"CI_REMOTE_URL", "PLUGIN_REMOTE", "DRONE_REMOTE_URL"},
		},
		&cli.StringFlag{
			Name:    "path",
			Usage:   "git clone path",
			EnvVars: []string{"CI_WORKSPACE", "PLUGIN_PATH", "DRONE_WORKSPACE"},
		},
		&cli.StringFlag{
			Name:    "sha",
			Usage:   "git commit sha",
			EnvVars: []string{"CI_COMMIT_SHA", "PLUGIN_SHA", "DRONE_COMMIT_SHA"},
		},
		&cli.StringFlag{
			Name:    "ref",
			Value:   "refs/heads/master",
			Usage:   "git commit ref",
			EnvVars: []string{"CI_COMMIT_REF", "PLUGIN_REF", "DRONE_COMMIT_REF"},
		},
		&cli.StringFlag{
			Name:    "event",
			Value:   "push",
			Usage:   "build event",
			EnvVars: []string{"CI_BUILD_EVENT", "DRONE_BUILD_EVENT"},
		},
		&cli.StringFlag{
			Name:    "netrc.machine",
			Usage:   "netrc machine",
			EnvVars: []string{"CI_NETRC_MACHINE", "DRONE_NETRC_MACHINE"},
		},
		&cli.StringFlag{
			Name:    "netrc.username",
			Usage:   "netrc username",
			EnvVars: []string{"CI_NETRC_USERNAME", "DRONE_NETRC_USERNAME"},
		},
		&cli.StringFlag{
			Name:    "netrc.password",
			Usage:   "netrc password",
			EnvVars: []string{"CI_NETRC_PASSWORD", "DRONE_NETRC_PASSWORD"},
		},
		&cli.IntFlag{
			Name:    "depth",
			Usage:   "clone depth",
